    ...
    <div>
        <div class="mt-6 w-full h-full overflow-hidden text-gray-700 bg-white
            ...
            <div class="flex justify-between">
                <form method="get" action="/search_cp_paiement" class="mt-2 ml-4">
                ...
                <tbody>
                    @foreach ($paiements as $paiement)
                        <tr class="border-b">
                            ...
                            <td class="p-4">
                                @if ($paiement->cp()->count())
                                    @if (
                                        $paiement->cp->conformite_procedure == 0 )
                                        <p
                                    ...
                                    @elseif ($paiement->cp->conformite_procedure == 1)
                                        <p
                                ...
                                @if ($paiement->cp()->count())
                                    <p class="text-sm">
                                        <x-rating-calculator :ratings="[
                                            $paiement->cp->conformite_procedure,
                                        ]" />
                                    </p>
                                @else
                                    <p class="text-sm">
                            ...
                            @can('nonDp')
                                <td class="p-4">
                                    <a href="{{ route('cpPaiement.edit', $paiement->cp->id) }}"
