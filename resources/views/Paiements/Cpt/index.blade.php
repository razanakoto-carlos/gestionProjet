    ...
    <div>
        <div class="mt-6 w-full h-full overflow-hidden text-gray-700 bg-white
            ...
            <div class="flex justify-between">
                <form method="get" action="/search_cpt_paiement" class="mt-2 ml-4">
                ...
                <tbody>
                    @foreach ($paiements as $paiement)
                        <tr class="border-b">
                            ...
                            <td class="p-4">
                                @if ($paiement->cpt()->count())
                                    @if ($paiement->cpt->qualite == 0 || $paiement->cpt->prix_unitaires == 0 || $paiement->cpt->total_global == 0)
                                        <p
                                    ...
                                    @elseif ($paiement->cpt->qualite == 1 && $paiement->cpt->prix_unitaires == 1 && $paiement->cpt->total_global == 1)
                                        <p
                                ...
                                @if ($paiement->cpt()->count())
                                    <p class="text-sm">
                                        <x-rating-calculator :ratings="[
                                            $paiement->cpt->qualite,
                                            $paiement->cpt->prix_unitaires,
                                            $paiement->cpt->total_global,
                                        ]" />
                                    </p>
                                @else
                                    <p class="text-sm">
                            ...
                            @can('nonDp')
                                <td class="p-4">
                                    <a href="{{ route('cptPaiement.edit', $paiement->cpt->id) }}"
